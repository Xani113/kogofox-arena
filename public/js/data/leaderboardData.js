/**
 * Kogofox Gaming Arena - Leaderboard Database
 */

export const LEADERBOARD_DATA = {
  global: [
    { rank: 1, name: "KogoPhantom", tag: "#FOX1", game: "Valorant", tier: "Radiant #1", rating: 2840, winRate: "78.4%", earnings: "$42,500", team: "Kogofox Prime", country: "🇺🇸", avatar: "🦊" },
    ...
    { rank: 5, name: "BooyahGod", tag: "#RUSH", game: "Free Fire", tier: "Grandmaster IV", rating: 2630, winRate: "74.8%", earnings: "$27,000", team: "Kogofox Rushers", country: "🇮🇳", avatar: "🔥" },
    ...
    { rank: 8, name: "MysticFanny", tag: "#KOG", game: "MOBA Legends", tier: "Mythical Glory", rating: 2510, winRate: "76.4%", earnings: "$19,500", team: "Kogofox Mystic", country: "🇵🇭", avatar: "🦅" }
  ],
  valorant: [
    { rank: 1, name: "KogoPhantom", tag: "#FOX1", tier: "Radiant #1", rating: 2840, winRate: "78.4%", kda: "1.68", main: "Jett / Omen", team: "Kogofox Prime", country: "🇺🇸", headshotRate: "38.2%" },
  ...
  pubg: [
    ...
    { rank: 3, name: "AirdropKing", tag: "#KOG", tier: "Master II", rating: 2520, winRate: "62.0%", avgKills: "7.2", mainWeapon: "Groza / SLR", team: "Kogofox Squad", country: "🇰🇷", dinners: 275 }
  ],
  freefire: [
    { rank: 1, name: "BooyahGod", tag: "#RUSH", tier: "Grandmaster IV", rating: 2630, winRate: "74.8%", headshots: "72%", mainChar: "Alok / Hayato", team: "Kogofox Rushers", country: "🇮🇳", booyahs: 512 },
  ...
  mobalegends: [
    ...
    { rank: 2, name: "MysticFanny", tag: "#KOG", tier: "Mythical Glory 120★", rating: 2510, winRate: "76.4%", kda: "7.9", mainHero: "Chou / Beatrix", team: "Kogofox Mystic", country: "🇵🇭", mvpCount: 540 },
  ...
  clashroyale: [
    ...
    { rank: 3, name: "BaitMasterX", tag: "#KOG", tier: "Ultimate Champion (3080)", rating: 2480, winRate: "72.5%", grandChallenges: 65, favoriteCard: "Goblin Barrel", team: "Kogofox Crown", country: "🇪🇸" }
  ]
};
