/**
 * Kogofox Gaming Arena - Tournaments & Bracket Database
 */
...
export const TOURNAMENTS_DATA = [
  {
    id: "tourney-val-01",
    gameId: "valorant",
    title: "Kogofox VCT Radiant Invitational",
    status: "LIVE",
    prizePool: "$25,000",
    ...
    bracket: {
      quarterFinals: [
        ...
        { matchId: "v-q4", team1: { name: "Gen.G Shadow", score: 2, odds: "1.90" }, team2: { name: "Kogofox Elite", score: 0, odds: "1.90" }, winner: "Gen.G Shadow", status: "COMPLETED" }
      ],
      semiFinals: [
  ...
  },
  {
    id: "tourney-moba-01",
    gameId: "mobalegends",
    title: "Kogofox Mythic Glory Invitational",
    status: "LIVE",
    prizePool: "$22,000",
    ...
    bracket: {
      quarterFinals: [
        ...
        { matchId: "m-q4", team1: { name: "Kogofox Mystic", score: 3, odds: "1.85" }, team2: { name: "EVOS Legends", score: 2, odds: "1.95" }, winner: "Kogofox Mystic", status: "COMPLETED" }
      ],
      semiFinals: [
        ...
        { matchId: "m-s2", team1: { name: "Bren Cyber", score: 0, odds: "1.90" }, team2: { name: "Kogofox Mystic", score: 0, odds: "1.90" }, status: "UPCOMING", currentMap: "Starts after SF1" }
      ],
      grandFinal: {
        matchId: "m-f1",
  ...
  },
  {
    ...
    bracket: {
      quarterFinals: [
        ...
        { matchId: "ff-q4", team1: { name: "Kogofox Rushers", score: 4, odds: "1.65" }, team2: { name: "Corinthians FF", score: 2, odds: "2.20" }, winner: "Kogofox Rushers", status: "COMPLETED" }
      ],
      semiFinals: [
        ...
        { matchId: "ff-s2", team1: { name: "Miners GG", score: 2, odds: "2.10" }, team2: { name: "Kogofox Rushers", score: 4, odds: "1.75" }, winner: "Kogofox Rushers", status: "COMPLETED" }
      ],
      grandFinal: {
        matchId: "ff-f1",
        team1: { name: "LOUD FreeFire", score: 3, odds: "1.90", logo: "🔥" },
        team2: { name: "Kogofox Rushers", score: 3, odds: "1.90", logo: "🦊" },
  ...
  },
  {
    id: "tourney-cr-01",
    gameId: "clashroyale",
    title: "Kogofox Crown Masters Invitational",
    status: "LIVE",
    prizePool: "$10,000",
    ...
    bracket: {
      quarterFinals: [
        ...
        { matchId: "cr-q4", team1: { name: "Kogofox CrownKing", score: 2, odds: "1.75" }, team2: { name: "Ruben CR", score: 0, odds: "2.10" }, winner: "Kogofox CrownKing", status: "COMPLETED" }
      ],
      semiFinals: [
        ...
        { matchId: "cr-s2", team1: { name: "Samuel Bassotto", score: 0, odds: "1.95" }, team2: { name: "Kogofox CrownKing", score: 0, odds: "1.85" }, status: "UPCOMING", currentMap: "Starts after SF1" }
      ],
      grandFinal: {
        matchId: "cr-f1",
